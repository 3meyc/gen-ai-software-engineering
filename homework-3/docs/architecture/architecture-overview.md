...
> NestJS microservices, Angular client, MongoDB shared cluster (one database per service). REST only in MVP. IDs: all `SVC-*` from [`../registry/scope-and-traceability.md`](../registry/scope-and-traceability.md).
...
**Canonical table:** [`specification.md` §4](../../specification.md#4-non-functional-and-policy) (11 metrics — do not duplicate here).

Summary: BFF read p95 &lt; 300 ms; confirm→apply &lt; 5 s for ≤500 txns; export cap 50k rows; ledger pagination 50 default / 200 max.
...
- [`../registry/scope-and-traceability.md`](../registry/scope-and-traceability.md)
- [`../api/public-routes.md`](../api/public-routes.md)
- [`../api/openapi/`](../api/openapi/)
- [`monorepo-and-tooling.md`](monorepo-and-tooling.md)
- [`../persistence/README.md`](../persistence/README.md)
- [`../domain/bank-provider-adapter.md`](../domain/bank-provider-adapter.md)
...
| §4 Non-functional | SLO table (canonical in spec §4) |
