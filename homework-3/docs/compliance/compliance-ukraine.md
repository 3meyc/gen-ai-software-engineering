...
| Mask secrets | Store `masked_pan`, never full PAN; tokens encrypted per [data-lifecycle-mvp.md](data-lifecycle-mvp.md) |
...
| Erasure | Household erasure request → orchestrated delete | [data-lifecycle-mvp.md](data-lifecycle-mvp.md) § Erasure |
...
Full field-level deletion matrix: [data-lifecycle-mvp.md](data-lifecycle-mvp.md).
...
- [`data-lifecycle-mvp.md`](data-lifecycle-mvp.md) — retention, erasure, token rotation
...
- [`scope-and-traceability.md`](../registry/scope-and-traceability.md) — `MO-7`, `MO-8`
