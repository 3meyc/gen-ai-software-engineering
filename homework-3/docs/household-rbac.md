...
- [`compliance-ukraine.md`](compliance-ukraine.md) — erasure and minimization
- [`scope-and-traceability.md`](scope-and-traceability.md) — `MO-4`
- [`architecture-overview.md`](architecture-overview.md) — BFF propagation
