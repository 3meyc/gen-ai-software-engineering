...
> Maps every transaction source to trust, validation, idempotency, and confirmation policy. IDs align with [`scope-and-traceability.md`](scope-and-traceability.md).
...
| `PH2-OCR` | Post-MVP | Always confirm; store receipt image per [data-lifecycle.md](data-lifecycle.md) |
...
- [`scope-and-traceability.md`](scope-and-traceability.md) — `MO-1`, `MO-2`, `PH2-*`
